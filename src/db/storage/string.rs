...
impl<'a> LockedDb<'a> {
    ...
    pub fn set_string(mut self, key: String, value: ValueEntry, manager:&EvictionManager) {
    ...
    pub fn get_string(self, key: String,manager:&EvictionManager) -> Option<ValueEntry> {
